            ...
            <CardBody>
              <Row>
                <div className="col">
                  ...
                  <span className="h2 font-weight-bold mb-0"> {PartnerDetails?.partnership?.companyPresentation}</span>
                </div>
                <Col className="col-auto">
                  <div className="icon icon-shape bg-danger text-white rounded-circle shadow">
                    <i className="fas fa-chart-bar" />
                    ...
                    <Row>
                      <Col lg="6">
                        <FormGroup>
                          ...
                          /> */}
                          <div>
                            <small>{PartnerDetails?.partnership?.name}</small>
                          </div>
                        </FormGroup>
                      </Col>
                      <Col lg="6">
                    ...
                    <Row>
                      <Col md="12">
                        <FormGroup>
                          ...
                          /> */}
                          <div>
                            <small>{PartnerDetails?.partnership?.companyWebSite}</small>
                          </div>
                        </FormGroup>
                      </Col>
                    </Row>
                    <Row>
                      <Col lg="4">
                        <FormGroup>
                          ...
                          /> */}
                          <div>
                            <small>{PartnerDetails?.partnership?.jobTitle}</small>
                          </div>
                        </FormGroup>
                      </Col>
                      <Col lg="4">
                        <FormGroup>
                          ...
                          <div>
                            <small>
                            {PartnerDetails?.partnership?.partnershipType}
                            </small>
                          </div>
                        </FormGroup>
                      </Col>
                      <Col lg="4">
                        <FormGroup>
                          ...
                          <div>
                            <small>
                            {PartnerDetails?.partnership?.TargetMarkets}
                            </small>
                          </div>
                        </FormGroup>
                      </Col>
                    ...
                    <Row>
                      <Col md="12">
                        <FormGroup>
                          ...
                          /> */}
                          <div>
                            <small>{PartnerDetails?.partnership?.DistrubutionSrategy}</small>
                          </div>
                        </FormGroup>
                      </Col>
                    </Row>
                    <Row>
                      <Col lg="4">
                        <FormGroup>
                          ...
                          /> */}
                          <div>
                            <small>{PartnerDetails?.partnership?.ProjectsForWhichYouPlanToUseTheSolution}</small>
                          </div>
                        </FormGroup>
                      </Col>
                      <Col lg="4">
