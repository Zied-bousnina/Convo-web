    ...
    <Col
      ...
      >
        ...
        <div className="input-group">
          ...
          <input type="text" required placeholder="Enter the name of the business" defaultValue={PartnerDetails?.name}  name={"name"} className={classNames("form-control")} onChange={onChangeHandler} />
          {/* {
    ...
    }
    {
      ...
      >
        ...
        <div className="input-group">
          ...
          <input type="text" required defaultValue={PartnerDetails?.contactName} placeholder="Enter the contact person's name" name={"contactName"} className={classNames("form-control")} onChange={onChangeHandler} />
          {/* {
            errors && (<div  className="invalid-feedback">
            {errors}
          </div>)
...

    {
      ...
      >
        ...
        <div className="input-group">
          ...
          <input type="text" required defaultValue={PartnerDetails?.addressPartner} placeholder="Enter the business address"  name={"addressPartner"} className={classNames("form-control")} onChange={onChangeHandler} />
          {/* {
            errors && (<div  className="invalid-feedback">
            {errors}
          </div>)
    ...
    }
    {
      ...
      >
        ...
        <div className="input-group">
          ...
          <input type="text" required defaultValue={PartnerDetails?.name}  placeholder="Enter the business phone number"  name={"phoneNumber"} className={classNames("form-control")} onChange={onChangeHandler}/>
          {/* {
            errors && (<div  className="invalid-feedback">
            {errors}
          </div>)
